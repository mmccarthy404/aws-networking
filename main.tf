...
module "vpc" {
  source = "https://github.com/terraform-aws-modules/terraform-aws-vpc?ref=v5.2.0" # v5.2.0
...
module "nat" {
  source        = "https://github.com/mmccarthy404/terraform-modules//terraform-aws-nat-instance?ref=v1.0.0"
